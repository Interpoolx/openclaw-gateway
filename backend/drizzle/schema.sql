-- D1 Database Schema for Clawpute (OpenClaw Admin Suite)
-- Run with: npx wrangler d1 execute openclaw_admin --local --file=./drizzle/schema.sql
-- Or: npx wrangler d1 execute openclaw_admin --remote --file=./drizzle/schema.sql
